...
RUN apt-get update && apt-get install -y php5-common php5-cli php5-mcrypt php5-mysql php5-apcu php5-gd php5-imagick php5-curl php5-intl php5-tidy php5-redis php5-pgsql php5-geoip
